    ...
    socket.on("response-user-is-typing", function (response) {
        ...
        if (response.currentGroupId) {
            if (response.currentUserId !== $("#dropdown-navbar-user").data("uid")) {
                ...
                $(`.chat[data-chat=${response.currentGroupId}]`).append(messagetyping); // dom đến màn hình chat
            ...
            $(`.chat[data-chat=${response.currentUserId}]`).append(messagetyping); // dom đến màn hình chat
