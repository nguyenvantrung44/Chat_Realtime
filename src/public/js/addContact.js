  ...
  $(".user-add-new-contact").bind("click", function () {
    ...
    $.post("/contact/add-new", { uid: targetId }, function (data) {
      if (data.success) {
        ...
        $("#find-user").find(`div.user-remove-request-contact-send[data-uid = ${targetId}]`).css("display", "inline-block");
        
        // js/caculateNotification.js
        increaseNumberNotification("noti_contact_counter", 1);

        // js/caculateNotifContact.js
...
socket.on("response-add-new-contact", function (user) {
  ...
  increaseNumberNotifContact("count-request-contact-received"); // js/caculateNotifContact.js
  ...
  removeRequesContactReceived(); // js/removeRequesContactReceived.js
